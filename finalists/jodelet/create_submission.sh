...
python mem_proposal.py --scenario="ni" --sub_dir="ni"
python mem_proposal.py --scenario="multi-task-nc" --sub_dir="multi-task-nc"
python mem_proposal.py --scenario="nic" --sub_dir="nic"
